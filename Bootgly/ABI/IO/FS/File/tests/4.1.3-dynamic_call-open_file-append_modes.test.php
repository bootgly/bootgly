...
return [
   ...
   'test' => function () {
      ...
      $File10->open(File::CREATE_APPEND_WRITEONLY_MODE);
      yield assert(
      ...
      $File11->open(File::CREATE_APPEND_READ_WRITE_MODE);
      yield assert(
      ...
      // @ Empty
      $File21 = new File('');
      $File21->open(File::CREATE_APPEND_WRITEONLY_MODE);
      yield assert(
      ...
      $File22 = new File('');
      $File22->open(File::CREATE_APPEND_READ_WRITE_MODE);
      yield assert(
         assertion: is_resource($File21->handler) === false,
      ...
      $File31->open(File::CREATE_APPEND_WRITEONLY_MODE);
      yield assert(
      ...
      $File32->open(File::CREATE_APPEND_READ_WRITE_MODE);
      yield assert(
