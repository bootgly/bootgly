...
return [
   ...
   'test' => function () {
      ...
      $File10->open(File::CONTINUOUS_WRITE_ONLY_MODE);
      assert(
      ...
      $File11->open(File::CONTINUOUS_WRITE_READ_MODE);
      assert(
      ...
      // @ Empty
      $File21 = new File('');
      $File21->open(File::CONTINUOUS_WRITE_ONLY_MODE);
      assert(
      ...
      $File22 = new File('');
      $File22->open(File::CONTINUOUS_WRITE_READ_MODE);
      assert(
         assertion: is_resource($File21->handler) === false,
      ...
      $File31->open(File::CONTINUOUS_WRITE_ONLY_MODE);
      assert(
      ...
      $File32->open(File::CONTINUOUS_WRITE_READ_MODE);
      assert(
