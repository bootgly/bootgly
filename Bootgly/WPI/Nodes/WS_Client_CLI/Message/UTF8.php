 ...
 * invalid sequence fails fast (RFC 6455 §8.1) instead of only after the final
 * fragment. A trailing multibyte sequence that spans a frame boundary is
 * carried as `pending` to the next chunk.
 *
