   ...
   test: function () {
      ...
      yield assert(
         assertion: $Invalid instanceof Exception
            && str_contains($Invalid->getMessage(), 'must return a Specification instance'),
         description: 'Non-Specification return aborts: ' . ($Invalid !== null ? $Invalid->getMessage() : 'NO THROW')
      );

      yield assert(
         assertion: $Valid === null
            && $ValidSlot instanceof E2ESpecification
