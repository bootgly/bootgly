...
return new Specification(
   description: 'It should support prepend() and append() for ordering control',
   test: new Assertions(Case: function (): Generator {
      ...
      // @ append B first
      $Pipeline->append($MiddlewareB);
      // @ prepend A (goes before B)
      $Pipeline->prepend($MiddlewareA);
      // @ append C (goes after B)
      $Pipeline->append($MiddlewareC);
      ...
      // :
      yield new Assertion(
         description: 'prepend() should place middleware first, append() should place at end',
      )
         ->expect($log)
         ->to->be(['A', 'B', 'C', 'handler'])
         ->assert();
