...
return new Test(
   description: 'Fixture should prioritize Test fixtures and inject by signature',
   ...
   test: new Assertions(Case: function (): Generator {
      ...
      yield (new Assertion(description: 'Test fixture overrides Suite fixture'))
         ->expect($OverrideSpec->Fixture)
         ->to->be($SpecFixture)
         ->assert();

      yield (new Assertion(description: 'injected fixture is the Test fixture'))
