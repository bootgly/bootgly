...
return new Test(
   ...
   test: new Assertions(Case: function (): Generator {
      ...
      yield (new Assertion(description: 'Assertions closure receives the Test fixture'))
         ->expect($Received)
         ->to->be($CaseFixture)
         ->assert();
      ...
      yield (new Assertion(description: 'direct Closure receives the Test fixture'))
      ...
      yield (new Assertion(description: 'Suite propagates its fixture to the first Test'))
         ->expect($FirstSpec->Fixture)
         ->to->be($SuiteFixture)
         ->assert();

      yield (new Assertion(description: 'Suite propagates its fixture to the second Test'))
