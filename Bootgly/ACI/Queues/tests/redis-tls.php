...
/*
 * Drives the native RESP queues driver over TLS against a stub Redis and prints one
 ...
 * which makes the native lane — the one QUEUE-13 lives in — unreachable in-process. The
 ...
 *
 * Nothing here is a test; the assertions live in `4.4-redis-tls-connect.Test.php`.
 */
...
/**
 * Fork a stub Redis — TLS or plain TCP — that answers `:1` to every command (echoing
