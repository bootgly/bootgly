...
/*
 * Drives the native RESP queues driver against a stub Redis and prints one JSON line
 ...
 * which makes the RESP path — the one QUEUE-11 lives in — unreachable in-process. The
 * spec starts it with the ini scan directory cleared so the extension is absent.
 *
 * Nothing here is a test; the assertions live in `4.3-redis-persistent-identity.Test.php`.
 */
