 ...
 *
 * Demonstrates reading Request properties: address, scheme, method, URI/URL/URN,
 * query/queries, headers, host/domain/subdomains, cookies, body (input/fields/files),
 * credentials, content negotiation and conditional (fresh / 304) responses.
 */
...
{
   yield $Router->route('/Request/test.a', function (Request $Request, Response $Response) {
   ...
   yield $Router->route('/Request/test.b', function (Request $Request, Response $Response) {
      return $Response->send($Request->raw);
   }, GET);

   yield $Router->route('/Request/test.c', function (Request $Request, Response $Response) {
      return $Response->JSON->send([
   ...
   yield $Router->route('/Request/test.d', function (Request $Request, Response $Response) {
      return $Response->JSON->send([
         'URI' => $Request->URI,
         'URL' => $Request->URL,
         'URN' => $Request->URN
   ...
   yield $Router->route('/Request/test.e', function (Request $Request, Response $Response) {
      return $Response->send($Request->query);
   }, GET);

   yield $Router->route('/Request/test.f', function (Request $Request, Response $Response) {
      return $Response->JSON->send($Request->queries);
   }, GET);

   yield $Router->route('/Request/test.g', function (Request $Request, Response $Response) {
      return $Response->JSON->send($Request->headers);
   }, GET);

   yield $Router->route('/Request/test.h', function (Request $Request, Response $Response) {
      return $Response->JSON->send([
         $Request->host,
   ...
   yield $Router->route('/Request/test.i', function (Request $Request, Response $Response) {
      return $Response->JSON->send(
         $Request->cookies
      );
   }, GET);

   yield $Router->route('/Request/test.j', function (Request $Request, Response $Response) {
      return $Response->send(
         $Request->input
      );
   });
   yield $Router->route('/Request/test.k', function (Request $Request, Response $Response) {
      return $Response->JSON->send(
         $Request->fields
      );
   });

   yield $Router->route('/Request/test.l', function (Request $Request, Response $Response) {
      return $Response->JSON->send(
         $Request->fields
      );
   });

   yield $Router->route('/Request/test.m', function (Request $Request, Response $Response) {
      return $Response->JSON->send(
         $Request->files
      );
   });

   yield $Router->route('/Request/test.x', function (Request $Request, Response $Response) {
      return $Response->JSON->send([
         $Request->username,
         $Request->password,
      ]);
   ...
   yield $Router->route('/Request/test.y', function (Request $Request, Response $Response) {
      return $Response->JSON->send(
         [
   ...
   yield $Router->route('/Request/test.z', function (Request $Request, Response $Response) {
   ...
   yield $Router->route('/requesting', function (Request $Request, Response $Response) {
      // * Data
      /*
