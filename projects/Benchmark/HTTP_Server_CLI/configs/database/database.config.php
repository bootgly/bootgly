...
return new Config(scope: 'database')
   ...
   ->Connections
      ->PostgreSQL
         ...
         ->Secure
            // ! Benchmark default: TLS off — the DB runs on localhost and every
            //   opponent connects in plaintext (README pins DB_SSLMODE=disable)
            ->Mode->bind(key: 'DB_SSLMODE', default: ADIConfig::SECURE_DISABLE)
            ->Verify->bind(key: 'DB_SSLVERIFY', default: false, cast: Types::Boolean)
