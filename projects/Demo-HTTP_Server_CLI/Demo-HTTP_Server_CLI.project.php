...
return new Project(
   ...
   boot: function (array $arguments = [], array $options = []): void
   {
      ...
      $Server->on(
         // # Test (Benchmarking)
         request: require __DIR__ . '/../Demo/HTTP_Server_CLI/router/HTTP_Server_CLI-benchmark-bootgly_router.SAPI.php',
         #request: require __DIR__ . '/../Demo/HTTP_Server_CLI/router/HTTP_Server_CLI-benchmark-static_router.SAPI.php',

         // # Test Request - Download (streaming decoder writes directly to disk)
         #request: require __DIR__ . '/../Demo/HTTP_Server_CLI/router/HTTP_Server_CLI-request-download.SAPI.php',
         // # Test Request - Basic request tests
         #request: require __DIR__ . '/../Demo/HTTP_Server_CLI/router/HTTP_Server_CLI-request.SAPI.php',

         // # Test Response - Basic response tests
         #request: require __DIR__ . '/../Demo/HTTP_Server_CLI/router/HTTP_Server_CLI-response.SAPI.php',
         // # Test Response - Scheduled (delayed/async) responses
         #request: require __DIR__ . '/../Demo/HTTP_Server_CLI/router/HTTP_Server_CLI-response-scheduled.SAPI.php',

         // # Test Router - all route cases from Testing.routes.php adapted to Generator pattern
         #request: require __DIR__ . '/../Demo/HTTP_Server_CLI/router/HTTP_Server_CLI-router.SAPI.php',
