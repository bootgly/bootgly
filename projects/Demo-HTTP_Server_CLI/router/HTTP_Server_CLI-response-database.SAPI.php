...
(Request $Request, Response $Response, Router $Router)
{
   ...
   $Connect = static function (Response $Response) use ($Describe): null|Database {
   ...
   $Execute = static function (Database $Database, Response $Response, string $sql, array $parameters, int $limit) use ($Send): null|Operation {
